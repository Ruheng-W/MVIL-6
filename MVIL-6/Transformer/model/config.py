...
def get_train_config():
    ...
    parse.add_argument('-lr', type=float, default=0.000015, help='学习率')
    ...
    parse.add_argument('-epoch', type=int, default=40, help='迭代次数')
    ...
    parse.add_argument('-interval-test', type=int, default=1, help='经过多少epoch对交叉验证集进行测试')
