...
train_dataset, test_dataset = Graph_Bert_Dataset(path='data/chem_ban.txt', addH=addH).get_data()
...
for epoch in range(10):
    ...
    for (batch, (x, adjoin_matrix, y, char_weight)) in enumerate(train_dataset):
        ...
        if batch % 500 == 0:
            ...
            # model.save_weights(arch['path'] + '/bert_weights{}_{}.h5'.format(epoch+1, (batch/500) + 1))
